...
const DisplayList = ({book}) => {
    ...
    return (
        <div className='border-gray-100 border-2 flex lg:flex-row flex-col rounded-xl mb-5 p-5 space-y-3'>
            <div>
                <img className='h-72' src={image} alt="" />

            </div>
            <div className='lg:ml-10 ml-0 space-y-5'>
                <h2 className='text-3xl font-semibold'>
                    {bookName}
                </h2>
                <p>By : {author}</p>
                <div className="flex lg:flex-row space-y-2 lg:space-y-0 flex-col items-center">
               ...
               <hr></hr>
               <div>
               <button  className="rounded-xl mr-3 px-3 py-2 lg:mb-0 mb-3 text-center bg-blue-200 text-blue-500 font-semibold">Category : {category}</button>
                    <button  className="rounded-xl mr-3 px-3 py-2 text-center lg:mb-0 mb-3 bg-orange-200 text-orange-500 font-semibold">Rating : {rating}</button>
